<template>
  <div data-v-63639bfc="" class="chat-wrapper">
    <div data-v-3b5cc8c8="" data-v-63639bfc="" class="chat">
  ...
  methods: {
    ...
    banUser(userId) {
      this.$root.request(
          ...
          '/graphql',
          {
            "query": "mutation banUserInChat($id: Int!) {banUserInChat(id: $id)}",
            "variables": {"id": userId},
            "operationName": "banUserInChat"
          }
      ).then(() => {
    ...
    deleteMessage(messageId) {
      this.$root.request(
          ...
          '/graphql',
          {
            "query": "mutation deleteMessage($id: String!) {deleteMessage(id: $id)}",
